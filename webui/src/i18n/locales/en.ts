const en = {
  ...
  setup: {
    ...
    passwordlessDesc: "Skip authentication — no password needed to open the console.",
    ...
    masterKeyWarning: "Save this key somewhere safe. It is required to decrypt your data when migrating or restoring the database. If you lose it, encrypted secrets cannot be recovered.",
